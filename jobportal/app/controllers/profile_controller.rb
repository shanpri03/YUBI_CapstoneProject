class ProfileController < ApplicationController
 ...
 def create
   current_user = User.find_by_id(session[:current_user_id])
    v =  !params[:first_name].empty? and !params[:last_name].empty? and !params[:email].empty? and !params[:contact].empty? and !params[:address].empty? and !params[:about].empty? and !params[:prof_pic].empty? and !params[:current_comp].empty? and !params[:ctc].nil? and !params[:experience].nil? 
    !params[:current_role].empty? and !params[:skills].empty? and !params[:exp_salary].nil? and !params[:pref_loc].empty? 
   if !current_user.nil?
    if v
